...
#resource "Assets\\DropOn.bmp"                 // image file
#resource "Assets\\DropOff.bmp"                // image file
//+------------------------------------------------------------------+
//| Class CComboBox                                                  |
...
public:
   ...
   bool              EditColor(const color value){ return m_edit.Color(value); }
   bool              EditColorBackground(const color value){ return m_edit.ColorBackground(value); }
   bool              EditColorBorder(const color value){ return m_edit.ColorBorder(value); }
   
   //bool              ListColor(const color value){ return m_list.Color(value); }
   bool              ListColorBackground(const color value){ return m_list.ColorBackground(value); }
   bool              ListColorBorder(const color value){ return m_list.ColorBorder(value); }
   
   void              DropColor(const color value){ m_list.ItemsColor(value); }
   void              DropColorBackground(const color value){ m_list.ItemsColorBackground(value); }
   void              DropColorBorder(const color value){ m_list.ItemsColorBorder(value); }
...
//--- create
   if(!m_drop.Create(m_chart_id,m_name+"Drop",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_drop.BmpNames("::Assets\\DropOff.bmp","::Assets\\DropOn.bmp"))
      return(false);
   if(!Add(m_drop))
      return(false);
   m_drop.Locking(true);
