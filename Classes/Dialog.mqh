...
//| Resources                                                        |
//+------------------------------------------------------------------+
#resource "Assets\\Close.bmp"
#resource "Assets\\Restore.bmp"
#resource "Assets\\Turn.bmp"
//+------------------------------------------------------------------+
//| Class CDialog                                                    |
...
//--- coordinates
   ...
   int y2=Height();
//--- create
   if(!m_white_border.Create(m_chart_id,m_name+"Border_ARTS_SCCMW",m_subwin,x1,y1,x2,y2))
      return(false);
...
//--- coordinates
   ...
   int y2=Height()-off;
//--- create
   if(!m_background.Create(m_chart_id,m_name+"Back_ARTS_SCCMW",m_subwin,x1,y1,x2,y2))
      return(false);
...
//--- create
   if(!m_caption.Create(m_chart_id,m_name+"Caption_ARTS_SCCMW",m_subwin,x1,y1,x2,y2))
      return(false);
...
//--- create
   if(!m_button_close.Create(m_chart_id,m_name+"Close_ARTS_SCCMWAR",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button_close.BmpNames("::Assets\\Close.bmp"))
      return(false);
...
//--- create_SCCMW
   if(!m_client_area.Create(m_chart_id,m_name+"Client_ARTS_SCCMW",m_subwin,x1,y1,x2,y2))
      return(false);
...
//--- coordinates
   ...
   int y2=y1+CONTROLS_BUTTON_SIZE;
//--- create
   if(!m_button_minmax.Create(m_chart_id,m_name+"MinMax_ARTS_SCCMW",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button_minmax.BmpNames("::Assets\\Turn.bmp","::Assets\\Restore.bmp"))
      return(false);
