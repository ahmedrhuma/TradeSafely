...
//| Resources                                                        |
//+------------------------------------------------------------------+
#resource "Assets\\CheckBoxOn.bmp"
#resource "Assets\\CheckBoxOff.bmp"
//+------------------------------------------------------------------+
//| Class CCheckBox                                                  |
...
public:
   ...
   bool              ColorBackgrund(const color value) { return m_label.ColorBackground(value); }
   bool              ColorBorder(const color value) { return m_label.ColorBorder(value); }
   bool              FontSize(const int value) { return m_label.FontSize(value); }
   //--- state
...
//--- create
   if(!m_button.Create(m_chart_id,m_name+"Button",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button.BmpNames("::Assets\\CheckBoxOff.bmp","::Assets\\CheckBoxOn.bmp"))
      return(false);
   if(!Add(m_button))
      return(false);
